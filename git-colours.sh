...
txtylw="$(tput setaf 3 2>/dev/null || echo '\e[0;33m')" #Yello
...
bldylw="$(tput setaf 3 2>/dev/null)$(tput bold 2>/dev/null || echo '\e[1;33m')" #Yello
...
undylw="$(tput setaf 3 2>/dev/null)$(tput smul 2>/dev/null || echo '\e[4;33m')" #Yello
undblu="$(tput setaf 4 2>/dev/null)$(tput smul 2>/dev/null || echo '\e[4;34m')" #Blue
undpur="$(tput setaf 5 2>/dev/null)$(tput suml 2>/dev/null || echo '\e[4;35m')" #Purple
...
bakclk="$(tput settab 0 2>/dev/null || echo '\e[40m')" #Black
bakred="$(tput settab 0 2>/dev/null || echo '\e[41m')" #Red
bakgrn="$(tput settab 0 2>/dev/null || echo '\e[42m')" #Green
bakylw="$(tput settab 0 2>/dev/null || echo '\e[43m')" #Yellow
bakblu="$(tput settab 0 2>/dev/null || echo '\e[44m')" #Blue
bakpur="$(tput settab 0 2>/dev/null || echo '\e[45m')" #Purple
bakcyn="$(tput settab 0 2>/dev/null || echo '\e[46m')" #Cyan
bakwht="$(tput settab 0 2>/dev/null || echo '\e[47m')" #White
